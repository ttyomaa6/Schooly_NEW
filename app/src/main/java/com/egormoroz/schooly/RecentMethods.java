    ...
    public static void showErrorMessage(ErrorList tag, TextView errorText) {
        switch (tag) {
            ...
            case ERROR_EMPTY_PHONE:
                ...
                break;
            case ERROR_SMALL_NICK:
                errorText.setText("The minimum number of symbols is 4");
                break;
        }
    }
    ...
    public static void MyMinersFromBase(String nick,FirebaseModel model, Callbacks.GetMyMinerFromBase callback) {
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot snap : snapshot.getChildren()) {
                    Miner miner = new Miner();
                    if(snap.child("inHour").exists()&&snap.child("minerPrice").exists()){
                        miner.setInHour(snap.child("inHour").getValue(Long.class));
                        miner.setMinerPrice(snap.child("minerPrice").getValue(Long.class));
                        miner.setMinerImage(snap.child("minerImage").getValue(String.class));
            ...
            public void onComplete(@NonNull Task<DataSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    for (DataSnapshot snap : snapshot.getChildren()) {
                        ...
                        if(snap.child("clothesPrice").exists()&&snap.child("purchaseNumber").exists()&&snap.child("purchaseToday").exists()&&
                                snap.child("x").exists() &&snap.child("y").exists()&&
                                snap.child("z").exists()&&snap.child("transformRatio").exists()
                        ) {
...
//    }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot snap:snapshot.getChildren()){
                    ...
                    if(snap.child("lookPrice").exists()&&snap.child("viewCount").exists()&&
                            snap.child("lookPriceDollar").exists()){
                ...
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        for (DataSnapshot snap:snapshot.getChildren()){
                            ...
                            if(snap.child("clothesProfit").exists()){
    ...
    public static UserInformation ValidateSnapToUserInformation(DataSnapshot snapshot){
        ...
        if(snapshot.child("todayMining").exists())
    ...
    public static void getDialogs(String nick,FirebaseModel firebaseModel,Callbacks.loadDialogs loadDialogs){
        ...
        firebaseModel.getUsersReference().child(nick).child("Dialogs").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snap:dataSnapshot.getChildren()){
                    Chat chat=new Chat();
                    if(snap.child("unreadMessages").exists()&&snap.child("timeMill").exists()) {
            ...
            public void onComplete(@NonNull Task<DataSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    for (DataSnapshot snap : snapshot.getChildren()) {
                        ...
                        if(snap.child("colorX").exists()&&snap.child("colorY").exists() &&snap.child("colorZ").exists()) {
                            facePart.setPartType(snap.child("partType").getValue(String.class));
                            facePart.setPartTitle(snap.child("partTitle").getValue(String.class));
                            facePart.setModel(snap.child("model").getValue(String.class));
                            facePart.setUid(snap.child("uid").getValue(String.class));
                            facePart.setFacePartImage(snap.child("facePartImage").getValue(String.class));
                            facePart.setColorX(snap.child("colorX").getValue(Float.class));
                            facePart.setColorY(snap.child("colorY").getValue(Float.class));
                            facePart.setColorZ(snap.child("colorZ").getValue(Float.class));
